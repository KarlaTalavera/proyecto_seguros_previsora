    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="estadisticasAdmin.php">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="polizasAdmin.php"><i class="fas fa-file-alt mr-1"></i> Polizas</a>
                        <a class="collapse-item" href="siniestrosAdmin.php"><i class="fas fa-ambulance mr-1"></i> Siniestros</a>
                    </div>
                </div>
            </li>

            <!-- clientes: icono mas acorde -->
            <li class="nav-item">
                <a class="nav-link" href="gestionCliente.php">
                    <i class="fas fa-fw fa-users"></i>
                    <span>Clientes</span>
                </a>
            </li>

            <!-- agentes: icono ya acorde pero mantener comentario -->
            <li class="nav-item">
                <a class="nav-link" href="gestionAgente.php">
            ...
            <li class="nav-item">
                <a class="nav-link" href="reportesAdmin.php">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Karla Talavera</span>
