...
<head>
    ...
    <style>
        ...
        .navbar.navbar-light.topbar {
            ...
            /* Se añade posición y Z-index superior al contenido */
            position: relative;
            z-index: 1000;
        }
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseReportes" class="collapse" aria-labelledby="headingReportes" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="index.php?vista=reportesGerenciales">Gerenciales</a>
                        <a class="collapse-item" href="index.php?vista=reportesSupervision">Supervisión</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="index.php?vista=reportesOperacionales">
                    <!-- icono: reportes -->
                    <i class="fas fa-fw fa-file-alt"></i>
                    <span>Reportes</span>
                </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- End of Topbar -->
                <!-- user dropdown move script moved to footer to ensure jQuery is loaded -->